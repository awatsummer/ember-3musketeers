...
class SectionInfo(FeatureType):
    ...
    def process_raw_features(self, raw_obj):
        ...
        entry_name_hashed = FeatureHasher(50, input_type="pair").transform([raw_obj['entry']]).toarray()[0]
        characteristics = [p for s in sections for p in s['props'] if s['name'] == raw_obj['entry']]
        characteristics_hashed = FeatureHasher(50, input_type="pair").transform([characteristics]).toarray()[0]
